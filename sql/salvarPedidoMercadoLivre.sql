...
BEGIN
    ...
    BEGIN
        INSERT INTO pedidos_mercadolivre_T(id_vendedor_mercadolivre_NM, order_id_NM, shipment_id_NM) VALUES (@id_vendedor_mercadolivre_NM, @order_id_NM, @shipment_id_NM);
    END
END;
GO